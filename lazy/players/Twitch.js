...
var Twitch = /* #__PURE__ */(function (_Component) {
  ...
  _createClass(Twitch, [{
    ...
    value: function load (url, isReady) {
      ...
      var playsinline = _this$props.playsinline
      ...
      (0, _utils.getSDK)(SDK_URL, SDK_GLOBAL).then(function (Twitch) {
        ...
        var READY = _Twitch$Player.READY
        var PLAYING = _Twitch$Player.PLAYING
        var PAUSE = _Twitch$Player.PAUSE
        var ENDED = _Twitch$Player.ENDED
        var ONLINE = _Twitch$Player.ONLINE
        var OFFLINE = _Twitch$Player.OFFLINE
