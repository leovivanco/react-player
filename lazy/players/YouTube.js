...
var YouTube = /* #__PURE__ */(function (_Component) {
  ...
  function YouTube () {
    ...
    _defineProperty(_assertThisInitialized(_this), 'parsePlaylist', function (url) {
      ...
      if (MATCH_PLAYLIST.test(url)) {
        ...
        var _url$match4 = _slicedToArray(_url$match3, 2)
        var username = _url$match4[1]
    ...
    _defineProperty(_assertThisInitialized(_this), 'onStateChange', function (event) {
      ...
      var onBufferEnd = _this$props.onBufferEnd
      var onEnded = _this$props.onEnded
      var onReady = _this$props.onReady
      var loop = _this$props.loop
      var _this$props$config = _this$props.config
      var playerVars = _this$props$config.playerVars
      var onUnstarted = _this$props$config.onUnstarted
      var _window$SDK_GLOBAL$Pl = window[SDK_GLOBAL].PlayerState
      var UNSTARTED = _window$SDK_GLOBAL$Pl.UNSTARTED
  ...
  _createClass(YouTube, [{
    ...
    value: function load (url, isReady) {
      ...
      var muted = _this$props2.muted
      var playsinline = _this$props2.playsinline
      var controls = _this$props2.controls
      var loop = _this$props2.loop
      var config = _this$props2.config
      var _onError = _this$props2.onError
      var playerVars = config.playerVars
      var embedOptions = config.embedOptions
