  ...
  _createClass(SoundCloud, [{
    ...
    value: function load (url, isReady) {
      ...
      (0, _utils.getSDK)(SDK_URL, SDK_GLOBAL).then(function (SC) {
        ...
        var PLAY = _SC$Widget$Events.PLAY
        var PLAY_PROGRESS = _SC$Widget$Events.PLAY_PROGRESS
        var PAUSE = _SC$Widget$Events.PAUSE
        var FINISH = _SC$Widget$Events.FINISH
        var ERROR = _SC$Widget$Events.ERROR
