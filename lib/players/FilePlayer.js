  ...
  _createClass(FilePlayer, [{
    ...
    value: function load(url) {
      ...
      var _this$props$config = this.props.config,
          ...
          drm = _this$props$config.drm,
          forceSHAKA = _this$props$config.forceSHAKA;
      var _this$props10 = this.props,
          setHlsPolyNet = _this$props10.setHlsPolyNet,
          setDashPolyNet = _this$props10.setDashPolyNet,
          setPrometheanTv = _this$props10.setPrometheanTv;
